  ...
  brief(
    ...
    [
      ...
      section("Роль соцсетей", [
        ...
        field("links", "Укажите ссылки на сайт, соцсети или каналы, которые уже ведёте", "textarea", "Сайт, Instagram, Telegram, VK, YouTube, другие площадки — всё, что важно посмотреть перед подготовкой предложения."),
      ...
      section("Контент", [
        ...
        { ...choice("brand_face", "Есть ли представитель бренда/компании, который готов участвовать в контенте?", ["Основатель / собственник", "Руководитель / эксперт компании", "Сотрудник / команда", "Амбассадор / лицо бренда", "Пока нет", "Другое"]), help: "Например: записывать короткие ролики, давать комментарии, участвовать в интервью или съёмках." },
