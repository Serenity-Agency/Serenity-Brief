const budgetOptions = [
  ...
  "700 000–1 500 000 ₽",
  "Более 1 500 000 ₽",
  "Бюджет пока не определен, нужна помощь с оценкой"
];
...
const serviceBudgetHelp = "Это поможет сразу предложить реалистичный формат работы. Можно выбрать предварительный диапазон. Без учета медиабюджета, производства и других внешних расходов.";
const externalBudgetHelp = "Без учета услуг Serenity. Можно выбрать предварительный диапазон.";
...
const commonSections = [
  {
    ...
    fields: [
      ...
      field("contact_social", "Мессенджер или другой контакт для связи", "text", "Telegram, WhatsApp или ссылка на профиль, где вам удобно общаться"),
...
const briefTypes = [
  brief(
    ...
    [
      ...
      section("Дополнительно", [
        ...
        field("additional", "Что еще важно добавить?", "textarea", "Ссылки, материалы или дополнительный комментарий")
      ])
    ],
    false
  ),
  brief(
    ...
    [
      ...
      section("Подтвержденные данные", [
        field("interviews", "Проводили ли интервью с потенциальными клиентами?", "textarea", "С кем говорили и что узнали?"),
        field("sales", "Есть ли подтвержденные продажи или активные пользователи?", "textarea"),
      ...
      section("Дополнительные вводные", [
        ...
        field("additional", "Что еще важно учесть при оценке задачи?", "textarea")
      ])
    ]
  ),
  brief(
    ...
    [
      ...
      section("Рынок и аудитория", [
        ...
        field("segments", "Какие сегменты клиентов для вас наиболее ценны?", "textarea", "Кто покупает чаще, больше и дольше остается"),
      ...
      section("Маркетинг и данные", [
        ...
        field("analytics", "Какие данные доступны?", "textarea", "CRM, сквозная аналитика, исследования, отчеты"),
      ...
      section("Дополнительные вводные", [
        ...
        field("materials", "Какие исследования и материалы уже можно изучить?", "textarea", "Исследования, отчеты, маркетинг-кит, брендбук"),
        field("additional", "Что еще важно учесть при оценке задачи?", "textarea")
      ])
    ]
  ),
  brief(
    ...
    [
      ...
      section("Продвижение сейчас", [
        field("channels", "Какие каналы работают сейчас?", "textarea", "Реклама, SEO, соцсети, PR, партнерства"),
  ...
  brief(
    ...
    [
      ...
      section("Реклама сейчас", [
        ...
        choice("crm_stack", "Какая CRM или система учета заявок используется?", ["amoCRM", "Битрикс24", "1C", "RetailCRM", "Самописная CRM", "Заявки в почте / мессенджерах", "CRM нет", "Не знаю"]),
  ...
  brief(
    ...
    [
      ...
      section("Сайт и спрос", [
        ...
        field("cms", "На какой CMS работает сайт?", "text"),
        field("directions", "Какие направления приоритетны?", "textarea"),
        field("regions", "Какие регионы важны?", "textarea"),
      ...
      section("История SEO", [
        ...
        field("site_changes", "Планируются ли крупные изменения сайта в ближайшие 6–12 месяцев?", "textarea", "Редизайн, смена CMS, перенос домена, изменение структуры")
      ]),
      section("Контент и конкуренты", [
        field("competitors", "С кем конкурируете в поиске?", "textarea"),
        field("references", "Есть ли сайты или компании, на которые ориентируетесь как на пример?", "textarea"),
      ...
      section("Цели и аналитика", [
        choice("analytics", "Какие системы аналитики подключены?", ["Яндекс Метрика", "Яндекс Вебмастер", "Google Analytics", "Google Search Console", "CRM", "Коллтрекинг", "Ничего", "Не знаю"]),
        choice("kpi", "Какой результат SEO важен бизнесу?", ["Увеличение трафика", "Рост заявок", "Увеличение продаж", "Снижение CPL", "Узнаваемость бренда", "Выход на новые рынки"]),
        field("materials", "Какие отчеты, исследования или материалы уже можно изучить?", "textarea")
      ])
    ]
  ),
  brief(
    ...
    [
      ...
      section("Роль соцсетей", [
        choice("goals", "Для чего бренду соцсети?", ["Продажи", "Узнаваемость", "Имидж", "Комьюнити", "Поддержка клиентов", "Работа с сотрудниками", "Продвижение личного бренда основателя/эксперта/сотрудника"]),
        field("platforms", "Какие площадки ведете или рассматриваете?", "textarea"),
        field("links", "Укажите ссылки на сайт, соцсети и каналы бренда", "textarea", "Сайт, Instagram, Telegram, VK, YouTube и другие площадки бренда, которые нам важно посмотреть перед подготовкой предложения."),
      ...
      section("Контент", [
        field("topics", "О чем бренд может говорить регулярно?", "textarea"),
        field("experts", "Кто может участвовать в создании контента?", "textarea"),
        { ...choice("brand_face", "Есть ли человек со стороны бренда, который готов участвовать в контенте?", ["Основатель / собственник", "Руководитель / эксперт компании", "Сотрудник / команда", "Амбассадор / лицо бренда", "Пока нет", "Другое"]), help: "Например: записывать короткие ролики, давать комментарии, участвовать в интервью или съемках." },
  ...
  brief(
    "website",
    "Бриф на сайт",
    "Для запуска или обновления сайта. Оценим задачи, материалы, функциональность и объем разработки.",
    "≈ 5–10 минут",
    [
      ...commonSections,
      ...
      section("Дополнительные вводные", [
        ...
        field("success", "По каким признакам вы поймете, что сайт решает задачу?", "textarea"),
        field("additional", "Что еще важно учесть при оценке сайта?", "textarea")
      ])
    ]
  ),
  brief(
    "ecommerce",
    "Интернет-магазин",
    "Для запуска или развития интернет-магазина. Оценим каталог, путь покупки, интеграции и объем проекта.",
    "≈ 15 минут",
    [
      ...commonSections,
      section("Каталог и продажи", [
        field("catalog", "Что продаем и как устроен каталог?", "textarea", "Категории, глубина вложенности, примерное количество товаров"),
      ...
      section("Управление и интеграции", [
        field("integrations", "С какими системами нужно связать магазин?", "textarea", "1С, CRM, склад, службы доставки, платежные системы"),
  ...
  brief(
    ...
    "Для нового бренда или обновления стиля. Оценим задачу, аудиторию, носители и объем работы.",
    "≈ 15 минут",
    [
      ...commonSections,
      section("Бренд", [
        choice("branding_task", "Какая задача стоит?", ["Новый бренд", "Ребрендинг", "Обновление стиля", "Логотип", "Гайдлайн", "Пока не знаем"], true),
        field("story", "Какой товар или услугу продвигает бренд и в чем ваше преимущество?", "textarea"),
      ...
      section("Аудитория и характер", [
        field("audience", "Для кого создаем бренд?", "textarea"),
  ...
  brief(
    ...
    [
      ...
      section("Объект нейминга", [
        field("object", "Для чего создаем название?", "textarea", "Компания, продукт, линейка, сервис, событие"),
        field("essence", "В чем суть продукта или бизнеса?", "textarea", "", true),
      ...
      section("Ограничения", [
        ...
        field("avoid", "Какие слова, темы и приемы нельзя использовать?", "textarea"),
  ...
  brief(
    ...
    [
      ...
      section("Публичная задача", [
        choice("pr_goal", "Что должен изменить PR?", ["Узнаваемость", "Доверие", "Репутация", "Поддержка продаж", "Выход на новый рынок", "Экспертность"], true),
        choice("pr_tool", "Какой PR-инструмент нужен?", ["PR: работа с изданиями и СМИ", "PR: работа с лидерами мнений / блогерами", "PR: работа с отзывами и репутацией", "PR: узнаваемость в digital / SERM", "Предложите решение"]),
        choice("audience", "На чье мнение нужно повлиять?", ["Конечный потребитель", "Общество в целом", "Категория граждан", "Закупщик / дистрибутор", "Производитель", "Представитель профессии", "Родитель", "Другое"], true),
        field("audience_detail", "Уточните аудиторию", "textarea", "Дополнительный комментарий, если выбрали «Другое» или хотите пояснить"),
        field("messages", "Какие мысли аудитория должна запомнить?", "textarea", "", true),
        field("risks", "Есть ли чувствительные темы или репутационные риски?", "textarea")
      ]),
      section("Инфополе", [
        field("media", "Где бренд уже представлен?", "textarea", "СМИ, рейтинги, конференции, соцсети", true),
        field("speakers", "Кто может выступать от лица компании?", "textarea", "", true),
        field("reasons", "Какие инфоповоды ожидаются?", "textarea", "", true),
        field("competitors", "Чью публичность считаете сильной?", "textarea", "", true),
        field("publicity_why", "Что именно нравится в их публичности?", "textarea")
      ]),
      section("Процессы", [
      ...
      <div class="result-card">
        <div class="result-head">
          <div>
            ...
            <p class="result-copy">Ответы сохранились у команды Serenity. Мы изучим задачу и вернемся к вам по указанному контакту.</p>
          </div>
...
function saveAnswers() {
  ...
  if (sessionToken) {
    ...
    setSaveStatus(saved ? "Черновик сохранен" : "Черновик только в этой вкладке", saved ? "" : "error");
  }
}
...
async function submitBrief() {
  ...
  if (window.google?.script?.run) {
    return new Promise((resolve, reject) => {
      window.google.script.run
        ...
        .withFailureHandler(() => reject(new Error("Не удалось отправить бриф. Попробуйте еще раз.")))
        .saveBrief(payload);
    });
  }
  ...
  if (!response.ok || !result?.ok) {
    throw new Error(result?.message || "Не удалось отправить бриф. Попробуйте еще раз.");
  }
...
document.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    render();
    setSaveStatus("Черновик сохранен", "error");
        ...
        <form id="create-form">
          ...
          <div class="form-actions">
            <button class="button" type="submit"${state.createSending ? " disabled" : ""}>
              ${state.createSending ? "Создаем…" : "Создать ссылку →"}
            </button>
          </div>
        </form>
      </div>
